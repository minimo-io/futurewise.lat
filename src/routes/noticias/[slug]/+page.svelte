...
<div class="relative py-10">
    <section class="max-w-[1200px] px-[32px] md:px-2 mx-auto md:pr-72 relative -top-[10px] md:top-0">
        <span class="partial-border partial-border-sm mb-4 font-normal text-white">Futurewise edição #1</span>
        <Heading
            tag="h1"
...
<div class="border-t border-t-gray-900 relative">
    <section class="max-w-[1200px] mx-auto flex flex-col md:flex-row gap-0 md:gap-20 relative">
        ...
        <aside class="w-full md:w-4/12 mt-10 md:mt-10 relative block -top-16 md:-top-28 order-0 md:order-1">
            <LatestArt {metadata} {sticky} showSubscribe promptText={metadata?.image.prompt} />
        </aside>
    </section>
</div>
